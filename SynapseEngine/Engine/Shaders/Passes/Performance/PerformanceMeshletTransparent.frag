...
{ 
    ...
    // 3. Write WBOIT Accumulation
    vec3 premultipliedColor = finalColor.rgb * finalColor.a;
    float weight = calculateWboitWeight(gl_FragCoord.z, finalColor.a);

    outAccum = vec4(premultipliedColor, finalColor.a) * weight;
    outReveal = finalColor.a;
}