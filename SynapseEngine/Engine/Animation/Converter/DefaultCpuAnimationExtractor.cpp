...
namespace Syn
{
    void DefaultCpuAnimationExtractor::Extract(CookedAnimation& cookedData, GpuBatchedAnimation& gpuData, CpuAnimationData& outCpuData) const
    {
        ...
        outCpuData.tracks = std::move(cookedData.tracks);
    }
}