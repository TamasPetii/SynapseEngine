...
namespace Syn
{
    SpotLightShadowDrawGroup::SpotLightShadowDrawGroup(uint32_t frameCount)
    {
        ...
        colorAtlasSpec.width = SPOT_SHADOW_ATLAS_SIZE;
        colorAtlasSpec.height = SPOT_SHADOW_ATLAS_SIZE;
        ...
        colorAtlasSpec.AddView(RenderTargetViewNames::SpotLightShadowTransparentColor, Vk::ImageViewConfig{
            .viewType = VK_IMAGE_VIEW_TYPE_2D,
            .swizzle = { VK_COMPONENT_SWIZZLE_R, VK_COMPONENT_SWIZZLE_G, VK_COMPONENT_SWIZZLE_B, VK_COMPONENT_SWIZZLE_ONE }
            });

        colorAtlasSpec.AddView(RenderTargetViewNames::SpotLightShadowTransparentDepth, Vk::ImageViewConfig{
            .viewType = VK_IMAGE_VIEW_TYPE_2D,
