...
namespace Syn
{
    ...
    public:
        ...
        virtual PhysicsBodyID CreateConvexBody(const glm::vec3& position, const glm::quat& rotation, std::span<const glm::vec3> vertices, const PhysicsBodySettings& settings) = 0;
        virtual PhysicsBodyID CreateMeshBody(const glm::vec3& position, const glm::quat& rotation, std::span<const glm::vec3> vertices, std::span<const uint32_t> indices, const PhysicsBodySettings& settings) = 0;
        ...
        virtual void SetConvexShape(PhysicsBodyID bodyId, std::span<const glm::vec3> newVertices) = 0;
