...
namespace Syn
{
    class SYN_API ConvexColliderSystem : public ComponentSystem<ConvexColliderComponent>
    {
    public:
        std::string GetName() const override { return "ConvexColliderSystem"; }
    ...
    protected:
        std::string GetSparseBufferName() const override { return BufferNames::ConvexColliderSparseMap; }
    protected:
