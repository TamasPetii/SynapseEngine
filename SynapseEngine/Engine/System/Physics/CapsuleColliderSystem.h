...
namespace Syn
{
    class SYN_API CapsuleColliderSystem : public ComponentSystem<CapsuleColliderComponent>
    {
    public:
        std::string GetName() const override { return "CapsuleColliderSystem"; }
        std::vector<TypeID> GetReadDependencies() const override;
        std::vector<TypeID> GetWriteDependencies() const override;
    protected:
        std::string GetSparseBufferName() const override { return BufferNames::CapsuleColliderSparseMap; }
    protected:
