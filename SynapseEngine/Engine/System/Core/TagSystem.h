...
namespace Syn
{
    class SYN_API TagSystem : public ComponentSystem<TagComponent>
    {
    public:
        std::string GetName() const override { return "TagSystem"; }
    ...
    protected:
        std::string GetSparseBufferName() const override { return BufferNames::TagSparseMap; }
