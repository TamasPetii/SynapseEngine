...
namespace Syn
{
    class SYN_API HemisphereMeshSource : public ShapeMeshSource
    {
    public:
        HemisphereMeshSource(float radius = 1.0f, uint32_t sectors = 32, uint32_t stacks = 16);
        virtual ~HemisphereMeshSource() override = default;
    protected:
