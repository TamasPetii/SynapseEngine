...
namespace Syn {
    ...
    void PointLightBillboardPass::PrepareFrame(const RenderContext& context) {
        ...
        copyRegion.dstBuffer = drawData->editorPointLightBillboardCmdBuffers[fIdx]->Handle();
        ...
        memBarrier.buffer = drawData->editorPointLightBillboardCmdBuffers[fIdx]->Handle();
    ...
    void PointLightBillboardPass::Draw(const RenderContext& context) {
        ...
        vkCmdDrawIndirect(
            context.cmd,
            drawData->editorPointLightBillboardCmdBuffers[fIdx]->Handle(),
            0,
            1,
