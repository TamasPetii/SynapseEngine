...
namespace Syn {
    ...
    bool DirectionLightBillboardPass::ShouldExecute(const RenderContext& context) const {
        ...
        return context.scene->GetSettings()->debug.enableBillboardDirectionalLights;
    }
    ...
    void DirectionLightBillboardPass::PrepareFrame(const RenderContext& context) {
        ...
        copyRegion.srcBuffer = drawData->DirectionLights.indirectBuffer.GetHandle(fIdx);
        copyRegion.dstBuffer = drawData->DirectionLights.billboardSingleCmdBuffer.GetHandle(fIdx);
        ...
        memBarrier.buffer = drawData->DirectionLights.billboardSingleCmdBuffer.GetHandle(fIdx);
    ...
    void DirectionLightBillboardPass::Draw(const RenderContext& context) {
        ...
        vkCmdDrawIndirect(
            context.cmd,
            drawData->DirectionLights.billboardSingleCmdBuffer.GetHandle(fIdx),
            0,
            1,
