#include "PerformanceTraditionalTransparentPass.h"
...
#include "Engine/Shaders/Includes/PushConstants/TraditionalPassPC.glsl"
    ...
    PerformanceTraditionalTransparentPass::PerformanceTraditionalTransparentPass(MaterialRenderType renderType)
        : _renderType(renderType)
    {
        _passName = (_renderType == MaterialRenderType::Transparent1Sided) ? "Perf_Traditional_Transparent_1Sided" : "Perf_Traditional_Transparent_2Sided";
    }

    void PerformanceTraditionalTransparentPass::Initialize() {
        ...
        _shaderProgram = shaderManager->CreateProgram("PerformanceTraditionalTransparentProgram", {
            ShaderNames::PerformanceTraditionalVert,
            ShaderNames::PerformanceTraditionalTransparentFrag
            }, config);
    ...
    void PerformanceTraditionalTransparentPass::PrepareFrame(const RenderContext& context) {
    ...
    void PerformanceTraditionalTransparentPass::PushConstants(const RenderContext& context) {
    ...
    void PerformanceTraditionalTransparentPass::BindDescriptors(const RenderContext& context) {
        auto imageManager = ServiceLocator::GetImageManager();
    ...
    void PerformanceTraditionalTransparentPass::Draw(const RenderContext& context) {
        auto scene = context.scene;
