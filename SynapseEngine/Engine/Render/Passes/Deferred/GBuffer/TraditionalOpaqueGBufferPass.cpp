#include "TraditionalOpaqueGBufferPass.h"
...
namespace Syn {
    ...
    TraditionalOpaqueGBufferPass::TraditionalOpaqueGBufferPass(MaterialRenderType renderType)
    ...
    void TraditionalOpaqueGBufferPass::Initialize() {
    ...
    void TraditionalOpaqueGBufferPass::PrepareFrame(const RenderContext& context) {
    ...
    void TraditionalOpaqueGBufferPass::PushConstants(const RenderContext& context) {
    ...
    void TraditionalOpaqueGBufferPass::BindDescriptors(const RenderContext& context)
    {
        auto imageManager = ServiceLocator::GetImageManager();
    ...
    void TraditionalOpaqueGBufferPass::Draw(const RenderContext& context)
    {
        auto scene = context.scene;
        auto drawData = scene->GetSceneDrawData();
        bool isGpu = scene->GetSettings()->enableGpuCulling;
