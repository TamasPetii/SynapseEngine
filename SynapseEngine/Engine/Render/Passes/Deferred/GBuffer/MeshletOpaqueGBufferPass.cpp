#include "MeshletOpaqueGBufferPass.h"
...
namespace Syn {
    ...
    MeshletOpaqueGBufferPass::MeshletOpaqueGBufferPass(MaterialRenderType renderType)
    ...
    void MeshletOpaqueGBufferPass::Initialize() {
    ...
    void MeshletOpaqueGBufferPass::PrepareFrame(const RenderContext& context) {
    ...
    void MeshletOpaqueGBufferPass::PushConstants(const RenderContext& context) {
    ...
    void MeshletOpaqueGBufferPass::BindDescriptors(const RenderContext& context)
    {
        auto imageManager = ServiceLocator::GetImageManager();
    ...
    void MeshletOpaqueGBufferPass::Draw(const RenderContext& context)
    {
        auto scene = context.scene;
        auto drawData = scene->GetSceneDrawData();
        bool isGpu = scene->GetSettings()->enableGpuCulling;
