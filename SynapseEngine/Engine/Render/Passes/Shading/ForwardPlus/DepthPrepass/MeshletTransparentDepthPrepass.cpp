#include "MeshletTransparentDepthPrepass.h"
...
namespace Syn {
    ...
    void MeshletTransparentDepthPrepass::PrepareFrame(const RenderContext& context) {
    ...
    void MeshletTransparentDepthPrepass::PushConstants(const RenderContext& context) {
    ...
    void MeshletTransparentDepthPrepass::BindDescriptors(const RenderContext& context)
    {
        auto imageManager = ServiceLocator::GetImageManager();
    ...
    void MeshletTransparentDepthPrepass::Draw(const RenderContext& context)
    {
        auto scene = context.scene;
        auto drawData = scene->GetSceneDrawData();
