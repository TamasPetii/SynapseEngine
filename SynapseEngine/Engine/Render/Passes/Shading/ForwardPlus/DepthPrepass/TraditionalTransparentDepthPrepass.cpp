...
namespace Syn {
    ...
    void TraditionalTransparentDepthPrepass::PrepareFrame(const RenderContext& context) {
    ...
    void TraditionalTransparentDepthPrepass::PushConstants(const RenderContext& context) {
