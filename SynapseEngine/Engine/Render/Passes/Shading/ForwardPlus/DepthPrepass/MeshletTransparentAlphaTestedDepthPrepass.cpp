...
#include "MeshletTransparentAlphaTestedDepthPrepass.h"
...
#include "Engine/Shaders/Includes/PushConstants/TraditionalMeshletPassPC.glsl"
    ...
    MeshletTransparentAlphaTestedDepthPrepass::MeshletTransparentAlphaTestedDepthPrepass(MaterialRenderType renderType)
        : _renderType(renderType)
    {
        ...
        if (_renderType == MaterialRenderType::AlphaTestedTransparent1Sided) {
            _passName = "MeshletTransparentAlphaTestedDepthPrepass1Sided";
        }
        else {
            _passName = "MeshletTransparentAlphaTestedDepthPrepass2Sided";
        }
    }

    void MeshletTransparentAlphaTestedDepthPrepass::Initialize() {
        ...
        _shaderProgramId = shaderManager->LoadProgramAsync("MeshletTransparentAlphaTestedDepthPrepassProgram", {
    ...
    void MeshletTransparentAlphaTestedDepthPrepass::PrepareFrame(const RenderContext& context) {
    ...
    void MeshletTransparentAlphaTestedDepthPrepass::PushConstants(const RenderContext& context) {
    ...
    void MeshletTransparentAlphaTestedDepthPrepass::BindDescriptors(const RenderContext& context)
    {
        auto imageManager = ServiceLocator::Get<ImageManager>();
    ...
    void MeshletTransparentAlphaTestedDepthPrepass::Draw(const RenderContext& context)
    {
        auto scene = context.scene;
        auto drawData = scene->GetSceneDrawData();
