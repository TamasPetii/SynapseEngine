#include "TraditionalOpaqueDepthPrepass.h"
...
namespace Syn {
    ...
    bool TraditionalOpaqueDepthPrepass::ShouldExecute(const RenderContext& context) const
    {
        return context.scene->GetSettings()->lighting.pipelineType == PipelineType::ForwardPlus;
    }

    TraditionalOpaqueDepthPrepass::TraditionalOpaqueDepthPrepass(MaterialRenderType renderType)
    ...
    void TraditionalOpaqueDepthPrepass::Initialize() {
        ...
        _shaderProgramId = shaderManager->LoadProgramAsync("TraditionalOpaqueDepthPrepassProgram", {
    ...
    void TraditionalOpaqueDepthPrepass::PrepareFrame(const RenderContext& context) {
    ...
    void TraditionalOpaqueDepthPrepass::PushConstants(const RenderContext& context) {
    ...
    void TraditionalOpaqueDepthPrepass::Draw(const RenderContext& context)
    {
        auto scene = context.scene;
        auto drawData = scene->GetSceneDrawData();
