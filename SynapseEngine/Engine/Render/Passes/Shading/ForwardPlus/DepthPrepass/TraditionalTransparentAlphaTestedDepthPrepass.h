...
namespace Syn {
    class SYN_API TraditionalTransparentAlphaTestedDepthPrepass : public GraphicsPass {
    public:
        TraditionalTransparentAlphaTestedDepthPrepass(MaterialRenderType renderType);
