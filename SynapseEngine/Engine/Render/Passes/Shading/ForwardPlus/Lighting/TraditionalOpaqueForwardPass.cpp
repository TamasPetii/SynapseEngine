...
namespace Syn {
        ...
        : _renderType(renderType)
    {
        ...
        if (_renderType == MaterialRenderType::Opaque1Sided) {
            _passName = "TraditionalOpaqueForward1Sided";
        }
        else {
            _passName = "TraditionalOpaqueForward2Sided";
        }
    }
    ...
    void TraditionalOpaqueForwardPass::Initialize() {
        ...
        _shaderProgramId = shaderManager->LoadProgramAsync("TraditionalOpaqueForwardProgram", {
