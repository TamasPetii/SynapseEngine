#include "TraditionalOpaqueForwardPass.h"
...
namespace Syn {
        ...
        : _renderType(renderType)
    {
        ...
        if (_renderType == MaterialRenderType::Opaque1Sided) {
            _passName = "Traditional_Opaque_Forward_1Sided";
        }
        else {
            _passName = "Traditional_Opaque_Forward_2Sided";
        }
    }

    void TraditionalOpaqueForwardPass::Initialize() {
        ...
        _shaderProgram = shaderManager->CreateProgram("TraditionalOpaqueForwardProgram", {
    ...
    void TraditionalOpaqueForwardPass::PushConstants(const RenderContext& context) {
    ...
    void TraditionalOpaqueForwardPass::Draw(const RenderContext& context)
    {
        auto scene = context.scene;
        auto drawData = scene->GetSceneDrawData();
