#include "TraditionalOpaqueDeferredPass.h"
...
namespace Syn {
    ...
    void TraditionalOpaqueDeferredPass::Initialize() {
    ...
    void TraditionalOpaqueDeferredPass::PrepareFrame(const RenderContext& context) {
    ...
    void TraditionalOpaqueDeferredPass::PushConstants(const RenderContext& context) {
    ...
    void TraditionalOpaqueDeferredPass::Draw(const RenderContext& context)
    {
        auto scene = context.scene;
        auto drawData = scene->GetSceneDrawData();
        bool isGpu = scene->GetSettings()->enableGpuCulling;
