...
namespace Syn {
    PointLightShadowAtlasRadixSortPass::~PointLightShadowAtlasRadixSortPass() {
    ...
    bool PointLightShadowAtlasRadixSortPass::ShouldExecute(const RenderContext& context) const {
    ...
    void PointLightShadowAtlasRadixSortPass::Execute(const RenderContext& context) {
        ...
        VkBuffer valuesHandle = compManager->GetComponentBuffer(BufferNames::PointLightShadowAtlasSortValueBuffer, fIdx).buffer->Handle();
