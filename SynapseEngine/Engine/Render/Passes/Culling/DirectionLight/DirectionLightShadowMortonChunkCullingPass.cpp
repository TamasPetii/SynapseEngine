...
namespace Syn {
    ...
    void DirectionLightShadowMortonChunkCullingPass::Initialize() {
        ...
        _shaderProgram = shaderManager->CreateProgram("DirectionLightShadowMortonChunkCullingProgram", {
    ...
    void DirectionLightShadowMortonChunkCullingPass::Dispatch(const RenderContext& context) {
        ...
        dispatchBarrier.buffer = drawData->DirectionLightShadow.mortonChunkDispatchBuffer.GetHandle(fIdx, isGpu);
