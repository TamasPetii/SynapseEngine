...
#include "Engine/Shaders/Includes/PushConstants/WireframeDebugPC.glsl"
    ...
    {
        return context.scene->GetSettings()->debug.enableMortonChunkAabbWireframe
    ...
    void MortonChunkAabbWireframePass::PrepareFrame(const RenderContext& context) {
        ...
        copyRegion.srcBuffer = drawData->Chunks.mortonIndirectDispatchBuffer.GetHandle(fIdx);
        copyRegion.dstBuffer = drawData->Chunks.mortonAabbSingleCmdBuffer.GetHandle(fIdx);
        ...
        memBarrier.buffer = drawData->Chunks.mortonAabbSingleCmdBuffer.GetHandle(fIdx);
    ...
    void MortonChunkAabbWireframePass::PushConstants(const RenderContext& context) {
        ...
        pc->shapeDrawType = WIREFRAME_DEBUG_SHAPE_TYPE_MORTON_CHUNK;
    ...
    void MortonChunkAabbWireframePass::Draw(const RenderContext& context) {
        ...
        auto indirectBuffer = drawData->Chunks.mortonAabbSingleCmdBuffer.GetHandle(fIdx);
