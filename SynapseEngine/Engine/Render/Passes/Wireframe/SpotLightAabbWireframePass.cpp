...
namespace Syn {
    ...
    void SpotLightAabbWireframePass::Draw(const RenderContext& context) {
        ...
        copyRegion.dstBuffer = drawData->debugSpotLightAabbCmdBuffers[fIdx]->Handle();
        ...
        memBarrier.buffer = drawData->debugSpotLightAabbCmdBuffers[fIdx]->Handle();
        ...
        vkCmdDrawIndirect(
            context.cmd,
            drawData->debugSpotLightAabbCmdBuffers[fIdx]->Handle(),
            0,
            1,
