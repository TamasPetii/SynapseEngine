#include "TraditionalOpaqueZPrepass.h"
...
namespace Syn {
    ...
    TraditionalOpaqueZPrepass::TraditionalOpaqueZPrepass(MaterialRenderType renderType)
    ...
    void TraditionalOpaqueZPrepass::Initialize() {
        ...
        _shaderProgram = shaderManager->CreateProgram("TraditionalOpaqueZPrepassProgram", {
    ...
    void TraditionalOpaqueZPrepass::PrepareFrame(const RenderContext& context) {
    ...
    void TraditionalOpaqueZPrepass::PushConstants(const RenderContext& context) {
    ...
    void TraditionalOpaqueZPrepass::BindDescriptors(const RenderContext& context)
    {
        auto imageManager = ServiceLocator::GetImageManager();
    ...
    void TraditionalOpaqueZPrepass::Draw(const RenderContext& context)
    {
        auto scene = context.scene;
        auto drawData = scene->GetSceneDrawData();
        bool isGpu = scene->GetSettings()->enableGpuCulling;
