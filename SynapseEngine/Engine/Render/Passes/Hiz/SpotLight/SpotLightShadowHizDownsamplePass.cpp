#include "SpotLightShadowHizDownsamplePass.h"
...
#include "Engine/Shaders/Includes/PushConstants/HizDownSamplePC.glsl"
    ...
    void SpotLightShadowHizDownsamplePass::PrepareFrame(const RenderContext& context) {
    ...
    void SpotLightShadowHizDownsamplePass::Dispatch(const RenderContext& context) {
        ...
        glm::vec2 currentInSize = glm::vec2(SPOT_SHADOW_ATLAS_SIZE, SPOT_SHADOW_ATLAS_SIZE);

        Vk::PushDescriptorWriter pushWriter;

        // Skip 0 -> SpotLightShadowHizCopyPass already done it!
