...
namespace Syn {
    class SYN_API DirectionLightShadowAtlasCachePass : public IRenderPass {
    public:
		virtual std::string GetName() const override { return "DirectionLightShadowAtlasCachePass"; }
