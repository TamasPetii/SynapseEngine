...
namespace Syn {
    class SYN_API DirectionLightShadowTraditionalTransparentPass : public GraphicsPass {
    public:
        DirectionLightShadowTraditionalTransparentPass(MaterialRenderType renderType);
