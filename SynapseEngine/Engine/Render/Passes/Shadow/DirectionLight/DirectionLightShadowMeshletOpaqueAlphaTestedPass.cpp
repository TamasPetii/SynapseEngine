#include "DirectionLightShadowMeshletOpaqueAlphaTestedPass.h"
...
#include "Engine/Shaders/Includes/PushConstants/DirectionLightShadowTraditionalMeshletPassPC.glsl"
    ...
    bool DirectionLightShadowMeshletOpaqueAlphaTestedPass::ShouldExecute(const RenderContext& context) const
    {
        ...
        : _renderType(renderType)
    {
        ...
        if (_renderType == MaterialRenderType::AlphaTestedOpaque1Sided) {
            _passName = "DirectionLightShadowMeshletOpaqueAlphaTestedPass1Sided";
        }
        else {
            _passName = "DirectionLightShadowMeshletOpaqueAlphaTestedPass2Sided";
        }
    }
    ...
    void DirectionLightShadowMeshletOpaqueAlphaTestedPass::PrepareFrame(const RenderContext& context) {
    ...
    void DirectionLightShadowMeshletOpaqueAlphaTestedPass::PushConstants(const RenderContext& context) {
    ...
    void DirectionLightShadowMeshletOpaqueAlphaTestedPass::BindDescriptors(const RenderContext& context)
    {
