...
namespace Syn {
    class SYN_API DirectionLightShadowMeshletTransparentPass : public GraphicsPass {
    public:
        DirectionLightShadowMeshletTransparentPass(MaterialRenderType renderType, bool isStaticPhase);
