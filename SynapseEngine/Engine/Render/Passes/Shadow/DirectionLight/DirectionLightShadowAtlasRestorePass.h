...
namespace Syn {
    class SYN_API DirectionLightShadowAtlasRestorePass : public IRenderPass {
    public:
		virtual std::string GetName() const override { return "DirectionLightShadowAtlasRestorePass"; }
