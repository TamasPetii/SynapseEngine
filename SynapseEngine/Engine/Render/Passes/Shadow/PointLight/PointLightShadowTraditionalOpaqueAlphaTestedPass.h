...
namespace Syn {
    class SYN_API PointLightShadowTraditionalOpaqueAlphaTestedPass : public GraphicsPass {
    public:
        PointLightShadowTraditionalOpaqueAlphaTestedPass(MaterialRenderType renderType);
