...
namespace Syn {
    class SYN_API PointLightShadowMeshletOpaqueAlphaTestedPass : public GraphicsPass {
    public:
        PointLightShadowMeshletOpaqueAlphaTestedPass(MaterialRenderType renderType);
