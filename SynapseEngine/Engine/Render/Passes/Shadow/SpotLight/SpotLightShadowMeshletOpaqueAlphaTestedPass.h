...
namespace Syn {
    class SYN_API SpotLightShadowMeshletOpaqueAlphaTestedPass : public GraphicsPass {
    public:
        SpotLightShadowMeshletOpaqueAlphaTestedPass(MaterialRenderType renderType);
