#include "SpotLightShadowTraditionalOpaquePass.h"
...
namespace Syn {
        ...
        : _renderType(renderType)
    {
        ...
        if (_renderType == MaterialRenderType::Opaque1Sided) {
            _passName = "SpotLightShadowTraditionalOpaquePass1Sided";
        }
        else {
            _passName = "SpotLightShadowTraditionalOpaquePass2Sided";
        }
    }

    void SpotLightShadowTraditionalOpaquePass::Initialize() {
    ...
    void SpotLightShadowTraditionalOpaquePass::PrepareFrame(const RenderContext& context) {
    ...
    void SpotLightShadowTraditionalOpaquePass::PushConstants(const RenderContext& context) {
    ...
    void SpotLightShadowTraditionalOpaquePass::BindDescriptors(const RenderContext& context)
    {
    ...
    void SpotLightShadowTraditionalOpaquePass::Draw(const RenderContext& context)
    {
        ...
        auto indirectBuffer = drawData->SpotLightShadow.indirectBuffer.GetHandle(context.frameIndex, isGpu);
