#include "MeshletTransparentPass.h"
...
namespace Syn {
    ...
    void MeshletTransparentPass::Initialize() {
    ...
    void MeshletTransparentPass::PrepareFrame(const RenderContext& context) {
    ...
    void MeshletTransparentPass::PushConstants(const RenderContext& context) {
    ...
    void MeshletTransparentPass::BindDescriptors(const RenderContext& context)
    {
        auto imageManager = ServiceLocator::GetImageManager();
    ...
    void MeshletTransparentPass::Draw(const RenderContext& context)
    {
        auto scene = context.scene;
        auto drawData = scene->GetSceneDrawData();
        bool isGpu = scene->GetSettings()->enableGpuCulling;
